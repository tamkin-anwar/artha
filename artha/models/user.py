...
class User(UserMixin, db.Model):
    ...
    accounts = db.relationship(
        "Account", backref="user", lazy="dynamic", cascade="all, delete-orphan"
    )
    net_worth_snapshots = db.relationship(
        "NetWorthSnapshot", backref="user", lazy="dynamic", cascade="all, delete-orphan"
    )
